...
// Print “Isosceles triangle.” if values for side1 is equal to side2 or side2 is equal to side3 //COMMENT ADDED: i assume side1 is equal to side3 is needed.
// Else “Scalene triangle.” since values of all sides are unequal.

if(side1==side2 && side2==side3){
    console.log("equilateral trianlge");
